  ...
  return (
    <LayoutCarousel>
      ...
      <div className="py-12 text-xs leading-7 text-center text-white uppercase bg-black bg-opacity-30 rounded-full sm:text-xl">
        ...
        <Link href="/home">
          <a className="animation inline-block p-4 text-2xl hover:text-yellow-600 bg-yellow-400 hover:bg-green-700 bg-opacity-80 bg-gradient-to-tl from-pink-800 rounded md:text-4xl leading-looses nm-inset-yellow-700-xs">
            Enter
          </a>
        </Link>
        <div className="p-6 animation" style={{ textShadow: "0px 5px 5px rgba(0, 0, 0, 0.9)" }}>
