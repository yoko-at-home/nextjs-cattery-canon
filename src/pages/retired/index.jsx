  ...
  return (
    <div key={props.id}>
      <div
        ...
        style={{ backgroundImage: "url(static/images/header/maincoon-on-white-background.jpg)" }}
      >
...
const Retired = (props) => {
  ...
  return (
    <Layout theme="newsArticles">
      <PageSEO title={`Retired- ${siteMetadata.author}`} description={siteMetadata.description} />
